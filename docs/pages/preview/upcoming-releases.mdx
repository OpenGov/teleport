...
The Core team adds support for hardware security modules - HSM for managing certificate authorities.
The team adds automatic fleet upgrades, improves access requests handlers,
improves first-time user experience of `teleport` and `tsh`.
